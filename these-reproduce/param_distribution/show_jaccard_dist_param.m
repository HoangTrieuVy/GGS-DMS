...
saveas(gcf, 'BSDS500_train_dist_param_Jaccard_log10.png')
figure(2)
scatter((lambda_list),(beta_list),'filled');
xlim([(min(lambda_list))-1 (max(lambda_list))+1]);
ylim([(min(beta_list))-1 (max(beta_list))+1]);
