...
folder_path = '../../dataset/BSDS500/data/param_dist_Jaccard_AT/train';
...
folder_path = '../../dataset/BSDS500/data/param_dist_PSNR_AT/train';
...
figure(1)
scatter((lambda_list_Jaccard),(beta_list_Jaccard),  50,'filled');hold on;
% scatter((lambda_list_PSNR),(beta_list_PSNR),50,'filled');
set(gca,'FontSize',30);
...
% xlim([-4.7 2]);
% ylim([-0.87 5.25])
% xlim([(min([lambda_list_Jaccard,lambda_list_PSNR]))-1 (max([lambda_list_Jaccard,lambda_list_PSNR]))+1]);
% ylim([(min([beta_list_Jaccard,beta_list_PSNR]))-1 (max([beta_list_Jaccard,beta_list_PSNR]))+1]);
saveas(gcf, 'SLPAM_AT_BSDS500_train_dist_param_PSNR_Jaccard.png')
