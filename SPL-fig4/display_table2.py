...
#                                                                objective='Jaccard',method='PALM-eps-descent',norm_type='AT-fourier',
#                                                                maxiter=mit,eps=2.,time_limit=360000,blur_type='Gaussian',
...
#                                                                stop_crit=1e-4,grid_size=5,max_round=5,
#                                                                objective='Jaccard',method='PALM-eps-descent',norm_type='AT-fourier',
#                                                                maxiter=60,eps=2.,time_limit=360000,blur_type='Gaussian',
#                                                                A=A,eps_AT_min=eps_min)
#
#print('PALM AT descent CT ',time.time()-start)
#ac=plt.figure(figsize=(8,8))
...
#plt.imshow(im_rec,'gray')
#draw_contour(cont_rec,'',fig=ac)
#plt.savefig('PALM-AT-descent-60iter.png', transparent = True, bbox_inches = 'tight', pad_inches = 0)
#
#
#print('PSNR PALM AT 60 iter descent',PSNR(im_rec,f))
#print('Jaccard PALM AT 60 iter descent', jaccard(cont_rec,e_exacte))
#
...
#                                                                maxiter=mit,eps=0.2,time_limit=360000,blur_type='Gaussian',
#                                                                A=A,eps_AT_min=eps_min)
#
...
#                                                                 maxiter=50,eps=2.,time_limit=360000,blur_type='Gaussian',
#                                                                 A=A,eps_AT_min=eps_min)
...
#                                                                 maxiter=50,eps=0.2,time_limit=360000,blur_type='Gaussian',
#                                                                 A=A,eps_AT_min=eps_min)
