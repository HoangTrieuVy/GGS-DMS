...
subplot(2,4,3);imagesc(u_rec);plot_contours(e_rec); title({'T-ROF ';['PSNR: ' num2str(plpsnr(f,u_rec),'%4.2f')];[ ' Jaccard: ' num2str(jaccard(e_rec,e_exacte),'%3.3f')]});
...
subplot(2,4,4);imagesc(u_rec);plot_contours(e_rec); title({'Hohm et al';['PSNR: ' num2str(plpsnr(f,u_rec),'%4.2f')];[ ' Jaccard: ' num2str(jaccard(e_rec,e_exacte),'%3.3f')]});
...
subplot(2,4,6);imagesc(u_rec);plot_contours(e_rec); title({'PALM l1';['PSNR: ' num2str(plpsnr(f,u_rec),'%4.2f')];[ ' Jaccard: ' num2str(jaccard(e_rec,e_exacte),'%3.3f')]});
...
subplot(2,4,8);imagesc(u_rec);plot_contours(e_rec); title({'PALM AT descent';['PSNR: ',num2str(plpsnr(f,u_rec),'%4.2f')];[' Jaccard: ' num2str(jaccard(e_rec,e_exacte),'%3.3f')]});
